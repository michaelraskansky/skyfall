...
_LOCATIONS: dict[str, Coords] = {
    ...
    "Hormuz": (27.06, 56.46),
    # --- Israeli cities (Hebrew, for Pikud HaOref Telegram) ---
    ...
    "ראשון לציון": (31.95, 34.80),
    "רחובות": (31.90, 34.81),
    "כפר סבא": (32.18, 34.91),
    "רעננה": (32.18, 34.87),
    "הגליל": (32.90, 35.30),       # Galilee region
    "השרון": (32.20, 34.87),       # Sharon region
    "הנגב": (30.85, 34.78),        # Negev region
    "עוטף עזה": (31.40, 34.40),   # Gaza envelope
    "גוש דן": (32.05, 34.80),     # Gush Dan / Tel Aviv metro
}
